...
class Game:
    ...
    def play(self):
        ...
        while True:
            ...
            for p in self.players:
                ...
                game_result.append(self.check_strike(p, input_numbers))
            game_round += 1
    ...
    def check_strike(self, player, guessed_nums):
        strike_count = ball_count = 0
        for i in range(3):
            if guessed_nums[i] == player.numbers[i]:
                strike_count += 1
            elif guessed_nums[i] in player.numbers:
                ball_count += 1
